...
bdry = insertRow(bdry, c('x'=49, 'y'=320), 7)
bdry = insertRow(bdry, c('x'=35, 'y'=266), 8)
bdry = insertRow(bdry, c('x'=9, 'y'=227), 9)
bdry = insertRow(bdry, c('x'=166, 'y'=17), 24)
bdry = insertRow(bdry, c('x'=159, 'y'=148), 25)
