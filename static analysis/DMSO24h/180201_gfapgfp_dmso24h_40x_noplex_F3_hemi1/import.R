...
bdry = insertRow(bdry, c('x'=-19, 'y'=-59), 20)
bdry = insertRow(bdry, c('x'=58, 'y'=-109), 21)
bdry = insertRow(bdry, c('x'=69, 'y'=-154), 22)
bdry = insertRow(bdry, c('x'=169, 'y'=-149), 28)
bdry = insertRow(bdry, c('x'=172, 'y'=-141), 29)
bdry = insertRow(bdry, c('x'=170, 'y'=-79), 30)
bdry = insertRow(bdry, c('x'=216, 'y'=10), 31)
bdry = insertRow(bdry, c('x'=258, 'y'=120), 32)
bdry = insertRow(bdry, c('x'=289, 'y'=169), 33)

# cells[which( abs(cells$x - 350) < 5 & abs(cells$y - 100) < 5 ), c("x", "y")]

# which(!inside.owin(bdry$x, bdry$y, cells.owin))
# bdry[10,] = bdry[10,] + c(-1e-6, +1e-6) # Prevents one point from getting outed by the window
