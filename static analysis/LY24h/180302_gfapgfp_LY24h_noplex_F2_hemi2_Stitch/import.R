...
bdry = insertRow(bdry, c('x'=382, 'y'=346), 6)
bdry = insertRow(bdry, c('x'=351, 'y'=347), 7)
bdry = insertRow(bdry, c('x'=299, 'y'=344), 8)
bdry = insertRow(bdry, c('x'=253, 'y'=355), 9)
bdry = insertRow(bdry, c('x'=157, 'y'=363), 10)
bdry = insertRow(bdry, c('x'=120, 'y'=354), 11)
bdry = insertRow(bdry, c('x'=98, 'y'=370), 12)
bdry = insertRow(bdry, c('x'=66, 'y'=377), 13)
bdry = insertRow(bdry, c('x'=24, 'y'=383), 14)
bdry[27,] = bdry[27,] + c(3, -2) # Prevents one point from getting outed by the window
bdry = insertRow(bdry, c('x'=40, 'y'=202), 28)
bdry = insertRow(bdry, c('x'=58, 'y'=174), 29)
bdry = insertRow(bdry, c('x'=68, 'y'=162), 30)
bdry = insertRow(bdry, c('x'=165, 'y'=128), 32)
bdry = insertRow(bdry, c('x'=246, 'y'=117), 33)
bdry = insertRow(bdry, c('x'=286, 'y'=94), 34)
